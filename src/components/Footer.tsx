...
import { Plus, Phone, MapPin, Clock, Calendar } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div className="space-y-4">
            <Link 
              href="/" 
              aria-label="Sharda Medical Store — Trusted Medical Store in Kawardha"
            ...
            <p className="text-sm text-slate-400 leading-relaxed">
              Operating for over {storeInfo.yearsOfService}+ years in Naveen Bazar, <strong>Sharda Medical Store in Kawardha</strong> is a leading retail pharmacy and wholesale medicine supplier across Kabirdham district.
            </p>
            <div className="pt-2">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start space-x-2.5">
                <Clock className="w-4.5 h-4.5 text-brand-accent mt-0.5 shrink-0" aria-hidden="true" />
                <div>
              ...
              <li className="flex items-start space-x-2.5">
                <Calendar className="w-4.5 h-4.5 text-amber-500 mt-0.5 shrink-0" aria-hidden="true" />
                <div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start space-x-2.5">
                <MapPin className="w-4.5 h-4.5 text-brand-accent mt-0.5 shrink-0" aria-hidden="true" />
                <span className="text-slate-400">
                  {storeInfo.location.address}, {storeInfo.location.city}, Chhattisgarh - 491995
                </span>
              </li>
              <li className="flex items-center space-x-2.5">
                <Phone className="w-4.5 h-4.5 text-brand-accent shrink-0" aria-hidden="true" />
                <a 
        ...
        <div className="mb-8">
          ...
          <div className="flex flex-wrap gap-2 text-[11px] text-slate-400 font-medium">
            <span className="px-2.5 py-1 bg-slate-800/60 rounded">Sharda Medical Store in Kawardha</span>
            <span className="px-2.5 py-1 bg-slate-800/60 rounded">Medical store Kawardha</span>
            <span className="px-2.5 py-1 bg-slate-800/60 rounded">Medical shop Kawardha</span>
            <span className="px-2.5 py-1 bg-slate-800/60 rounded">Pharmacy Kawardha</span>
            ...
            <span className="px-2.5 py-1 bg-slate-800/60 rounded">Chemist Naveen Bazar Kawardha</span>
